<h1 class="title">Course Enrollments Management</h1>
    ...
    <div class="table-management main-content">
        ...
        <?php
            ...
            // Query to fetch data from the 'enrollments' table and join with 'users' and 'courses' tables
            $query = "SELECT e.enrollment_id, e.user_id, u.username, e.course_id, c.course_name, e.enrollment_date 
                FROM enrollments e
